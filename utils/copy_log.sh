...
# 日志存储目录
LOG_PATH=$(get_config "SYNO_Config" "LOCAL_LOG_FILE_PATH")


# 设置远程服务器信息
REMOTE_USER=$(get_config "SYNO_Config" "REMOTE_USER")
REMOTE_HOST=$(get_config "SYNO_Config" "REMOTE_HOST")
REMOTE_DIR=$(get_config "SYNO_Config" "REMOTE_DIR")
REMOTE_PORT=$(get_config "SYNO_Config" "REMOTE_PORT")
