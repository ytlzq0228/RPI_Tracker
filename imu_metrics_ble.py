...
save_log(f"IMU {VERSION} Starting...")
save_log("IMU Get Config Params:")
save_log(f"IMU Param IMU_ENABLE:{IMU_ENABLE}")
save_log(f"IMU Param BLE_MAC:{BLE_MAC}")
save_log(f"IMU Param INCLUDE_RAW_SEGMENT_IN_EVENT:{INCLUDE_RAW_SEGMENT_IN_EVENT}")
save_log(f"IMU Param EVENT_PRE_SEC:{EVENT_PRE_SEC}")
save_log(f"IMU Param EVENT_POST_SEC:{EVENT_POST_SEC}")
save_log(f"IMU Param TH_BRAKE_MPS2:{TH_BRAKE_MPS2}")
save_log(f"IMU Param TH_ACCEL_MPS2:{TH_ACCEL_MPS2}")
save_log(f"IMU Param TH_TURN_MPS2:{TH_TURN_MPS2}")
save_log(f"IMU Param TH_IMPACT_G:{TH_IMPACT_G}")
save_log(f"IMU Param TH_BUMP_RMS_MPS2:{TH_BUMP_RMS_MPS2}")
